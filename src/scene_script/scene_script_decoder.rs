...
use crate::scene_script::ops_animation::op_decode_animation;
use crate::scene_script::ops_audio::op_decode_audio;
use crate::scene_script::ops_call::op_decode_call;
...
pub fn op_decode(data: &mut Cursor<Vec<u8>>) -> Op {
    ...
    match op_byte {
        ...
        0x0E | 0x89 | 0x8A | 0x21 | 0x22 | 0x8B | 0x8C | 0x8D | 0xF8 | 0xF9 | 0xFA => op_decode_actor_props(op_byte, data),
