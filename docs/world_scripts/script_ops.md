...
| 49  | `$31` | X | `move`       | u8 steps                                               | Move actor by vector components for given amount of cycles. Runs animation ops on every cycle. |
...
| 57  | `$39` | X | `anmwait`    | u8 delay                                               | Waits for a given number of cycles. Runs animation ops on every cycle.                         |
